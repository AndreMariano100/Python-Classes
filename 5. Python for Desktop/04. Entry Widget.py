...
frame_1.grid(row=0, column=0, sticky='nsew', padx=5, pady=2)
frame_1.columnconfigure(0, weight=1)
frame_1.columnconfigure(1, weight=1)

frame_2 = tk.LabelFrame(root, text='Using tk.StringVar()')
frame_2.grid(row=0, column=1, sticky='nsew', padx=(0, 5), pady=2)
...
if True:
    ...
    button_100.grid(row=3, column=0, columnspan=2, sticky='nsew', padx=10, pady=10)

    entry_103 = tk.Entry(frame_1, justify='center')
    ...
    button_101.grid(row=5, column=0, columnspan=2, sticky='nsew', padx=10, pady=10)
...
if True:
    ...
    button_200.grid(row=3, column=0, columnspan=2, sticky='nsew', padx=10, pady=10)

    result_1 = tk.DoubleVar(value=0)
    entry_203 = tk.Entry(frame_2, textvariable=result_1, state='readonly', justify='center')
    entry_203.grid(row=4, column=0, columnspan=2, sticky='nsew', padx=2, pady=2)

    button_201 = tk.Button(frame_2, text='Delete All', command=delete_all_2)
    button_201.grid(row=5, column=0, columnspan=2, sticky='nsew', padx=10, pady=10)
