...
button1.grid(row=1, column=0, sticky='nsew', pady=(0, 10))

button2 = tk.Button(root, text='Show Warning', command=lambda: popup('warning'))
button2.grid(row=2, column=0, sticky='nsew', pady=(0, 10))

button3 = tk.Button(root, text='Show Error', command=lambda: popup('error'))
button3.grid(row=3, column=0, sticky='nsew', pady=(0, 10))

button4 = tk.Button(root, text='Ask Question', command=lambda: popup('question'))
button4.grid(row=4, column=0, sticky='nsew', pady=(0, 10))

button5 = tk.Button(root, text='Ask OK/CANCEL', command=lambda: popup('ok/cancel'))
button5.grid(row=5, column=0, sticky='nsew', pady=(0, 10))

button6 = tk.Button(root, text='Ask YES/NO', command=lambda: popup('yes/no'))
button6.grid(row=6, column=0, sticky='nsew', pady=(0, 10))

button7 = tk.Button(root, text='Why not...Color Chooser', command=lambda: popup('color'))
button7.grid(row=7, column=0, sticky='nsew', pady=(0, 10))
